        ...
        <nav class="container mx-auto px-4 py-4">
            <div class="flex justify-between items-center">
                <div class="text-2xl font-bold text-blue-600">
                    <a href="/">Otel Rezervasyon</a>
                </div>
                <div class="hidden md:flex space-x-6">
                    <a href="/" class="text-gray-700 hover:text-blue-600">Ana Sayfa</a>
                    <a href="/oteller" class="text-gray-700 hover:text-blue-600">Oteller</a>
                ...
                <div class="hidden md:flex space-x-4">
                    <a href="/giris" class="px-4 py-2 text-blue-600 hover:text-blue-700">Giriş Yap</a>
                    <a href="/kayit" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">Kayıt Ol</a>
                </div>
            </div>
        </nav>
    </header>
        ...
        <div class="container mx-auto px-4 py-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                    ...
                    <p class="text-gray-400">En iyi otel rezervasyon deneyimi için buradayız.</p>
                </div>
                <div>
                    <h3 class="text-lg font-semibold mb-4">Hızlı Bağlantılar</h3>
                    <ul class="space-y-2">
                        <li><a href="/oteller" class="text-gray-400 hover:text-white">Oteller</a></li>
                        <li><a href="/kampanyalar" class="text-gray-400 hover:text-white">Kampanyalar</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-gray-400">
                        <li>info@otelrezervasyon.com</li>
